...
import weatherIconImg from "../../images/weather-icon.webp";
import humidityIconImg from "../../images/humidity-icon.png";
import windIconImg from "../../images/wind-icon.png";
import weatherClearIcon from "../../images/weather-clear.png";
import weatherCloudsIcon from "../../images/weather-clouds.png";
import weatherDrizzleIcon from "../../images/weather-drizzle.png";
import weatherMistIcon from "../../images/weather-mist.webp";
import weatherRainIcon from "../../images/weather-rain.webp";
import weatherSmokeIcon from "../../images/weather-smoke.png";
import weatherSnowIcon from "../../images/weather-snow.webp";
  ...
  useEffect(() => {
    if (coordinates.lat && coordinates.lng) {
      weatherData(coordinates.lat, coordinates.lng).then((data) => {
        ...
        if (data) {
          console.log(data);
          setWeather(data.weather.discription)
          setData(data.main)
          setCity(data.name);
